...
static void init_pos_pid(void) {
    ...
    connect_pins("fb_switch", 0, "com_abs_pos", "enocder",  0, "com_abs_pos");
    ...
    /* External command */
    connect_pins("vel", 0, "pos_in", "encoder", 0, "mot_pos");

    /* Position PID */
    connect_pins("pid", 0, "acc_ext_cmd",   "dbg", 0, "step");
    ...
    /* Debug */
    connect_pins("dbg", 0, "in0", "dbg",        0, "step");
    connect_pins("dbg", 0, "in1", "vel",        1, "vel");
    connect_pins("dbg", 0, "in2", "vel",        0, "vel");
    connect_pins("dbg", 0, "in3", "pid",        0, "cur_cor_cmd");
