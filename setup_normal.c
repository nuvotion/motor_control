...
static void init_pos_pid(void) {
    ...
    set_pin_val("vel", 0, "d",  0.9);
    set_pin_val("vel", 1, "d",  0.9);
    set_pin_val("vel", 2, "d",  0.9);
    ...
    set_pin_val("pid", 0, "max_usr_acc",    60000); // Default
    set_pin_val("pid", 0, "max_usr_torque", 60000); // Default
